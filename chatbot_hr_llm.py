...
st.subheader("Chat with the assistant to know more about Hrishikesh!")
...
prompt_template = ChatPromptTemplate.from_messages(
    [("system", "You are a helpful AI assistant to help provide information about Hrishikesh. You will reply to questions only based on the context that you are provided. If something is out of context, you will refrain from replying and politely decline to respond to the user."), ("user", "{input}")]
)
user_input = st.chat_input("Can you provide a general overview of Hrishikesh's experience?")
llm = ChatNVIDIA(model="mixtral_8x7b")
